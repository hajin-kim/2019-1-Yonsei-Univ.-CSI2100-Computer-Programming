def countLetters(line):
    ...
    # answer_textfile = open('anwser.txt', 'w') # Feedback : -25(100%) file name typo anwser.txt
    answer_textfile = open('answer.txt', 'w')   # Feedback
    ...
    # Feedback : -25(100%) file name typo anwser.txt
